...
namespace LeiaLoft
{
    ...
    public partial class LeiaDisplay : Singleton<LeiaDisplay>, IFaceTrackingDisplay
    {
        ...
        public bool _interlaceInEditor = true;
        public bool InterlaceInEditor
        {
            get
            {
                return _interlaceInEditor;
            }
            set
            {
                _interlaceInEditor = value;
            }
        }
        ...
        public bool _usingSimulatedFacePosition;
        public bool UsingSimulatedFacePosition
        {
            set
            {
                _usingSimulatedFacePosition = value;
            }
            get
            {
                return _usingSimulatedFacePosition;
            }
        }
        public float maxDpiForBlackViews = 480.0f;
...
#pragma warning disable CS0618 // Type or member is obsolete
        ...
        //To force black views on or off, set BlackViewsOverride to true,
        //then set BlackViewsOverrideValue to true or false based on if you want it forced on or off.
        ...
        public bool blackViews
        {
            get
            {
                ...
                //If the DPI is greater than the max DPI for black views, then turn off black views
                if (Screen.dpi > LeiaDisplay.Instance.maxDpiForBlackViews)
                {
                    return false;
                }
                return true;
        ...
        private class CNSDKHolder
        {
            ...
            public static Leia.SDK Get()
            {
                if (!_isInitialized)
                {
                    ...
                    Leia.LogLevel logLevel = Leia.LogLevel.Off;
                    try
                    {
        ...
        private void OnEnable()
        {
            ...
            OriginalSingleTapActCoeff = sdkConfig.act_singleTapCoef;
            if (error != 0)
            {
            ...
            EyeTracking eyeTracker = this.tracker;
            SpawnLeiaConfigUI();
        }
        ...
        private EyeTracking _tracker;
        public EyeTracking tracker
        {
            get
            {
                if (_tracker == null)
                {
                    _tracker = FindObjectOfType<EyeTracking>();
                    if (_tracker == null)
                    {
                        ...
                        if (_tracker == null)
                        {
                            Debug.LogError("_tracker is still null! even after adding the component");
                        }
                    }
                }
        ...
        void SpawnLeiaConfigUI()
        {
            GameObject leiaConfigUIPrefab = Resources.Load("Prefabs/LeiaConfigUI", typeof(GameObject)) as GameObject;
            if (leiaConfigUIPrefab == null)
            {
                Debug.LogError("Leia Config UI prefab is null!");
            }

            GameObject eyeTrackingGameObject = Instantiate(leiaConfigUIPrefab);
            eyeTrackingGameObject.transform.parent = transform;
        }
        ...
        public void RenderImage(LeiaCamera camera)
        {
            ...
            {
                viewerPositionPredicted = new Vector3(
                    this.SimulatedFaceX,
                    this.SimulatedFaceY,
                    this.SimulatedFaceZ
                );
            ...
            else
            {
                if (dynamicReconvergence && tracker != null)
                {
                    ...
                    viewerPositionPredicted = tracker.GetPredictedFacePosition();
                    viewerPositionNonPredicted = tracker.GetNonPredictedFacePosition();
                }
                else
                {
                    viewerPositionPredicted = new Vector3(0, 0, displayConfig.ConvergenceDistance);
                    viewerPositionNonPredicted = new Vector3(0, 0, displayConfig.ConvergenceDistance);
                }
            }
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [SerializeField] public Vector3 viewerPositionPredicted = new Vector3(0, 0, 535.964f);
        ...
        float getPeelOffset()
        {
            ...
            float PeelOffset = (getN(viewerPositionPredicted.x, viewerPositionPredicted.y, viewerPositionPredicted.z, 0f, 0f)
                - No);
