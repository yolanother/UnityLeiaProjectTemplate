...
namespace LeiaLoft
{
    ...
    public struct LeiaStateDecorators
    {
        ...
        [SerializeField] private bool multiCameraCompositFlag;
        public bool MultiCameraComposit {
            get { return multiCameraCompositFlag; }
            set { multiCameraCompositFlag = value; }
        }
        [SerializeField] private bool interlaceInEditor;
        public bool InterlaceInEditor {
            get { return interlaceInEditor; }
            set { interlaceInEditor = value; }
        }
        ...
        public override string ToString()
        {
            return string.Format("[LeiaStateDecorators: ShowTiles={0}, ShowCalibration={1},"
                ...
                ShowTiles, ShowCalibration, ParallaxAutoRotation, ShouldParallaxBePortrait, ParallaxOrientation, RenderTechnique, AdaptFOV, MultiCameraComposit, backgroundInterpolationCoefficient);
        }
    }
}