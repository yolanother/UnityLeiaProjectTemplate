    ...
    public LeiaHeadTracking.Engine Initialize()
    {
        if (!initialized)
        {
            ...
            try
            {
                ...
                initArgs.logLevel = Leia.LogLevel.Trace;
#endif
            ...
            headTrackingEngine = new LeiaHeadTracking.Engine(ref initArgs);

            Leia.Vector3 cameraPosition;
            ...
            catch (LeiaHeadTracking.NativeCallFailedException e)
            {
