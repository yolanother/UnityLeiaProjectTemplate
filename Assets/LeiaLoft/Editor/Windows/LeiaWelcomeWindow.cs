    ...
    public class LeiaWelcomeWindow 
    {
        ...
        void InitUI()
        {
            ...
            sampleScenes.Elements.Add(new WelcomeUIElement(
                  ...
                  "Open MultipleCameraCompositing Scene",
                  () => { EditorSceneManager.OpenScene(string.Format("{0}{1}", modulesPath, "MultipleCameraCompositing/Examples/MultipleCameraCompositing.unity")); }, true));
